...
import io.deeplay.camp.botfarm.bots.matthew_bots.evaluate.MonteCarloEvaluator;
...
public class MonteCarloMinimaxBot extends MovementBot {
     ...
     */
    public MonteCarloMinimaxBot(int maxDepth) {
        super(new TreeAnalyzer(), maxDepth);
        gameStateEvaluator = new MonteCarloEvaluator(100);
    }
