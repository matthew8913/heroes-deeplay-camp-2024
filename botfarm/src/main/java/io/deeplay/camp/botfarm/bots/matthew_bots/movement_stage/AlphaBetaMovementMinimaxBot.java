 ...
 * movement.
 */
public class AlphaBetaMovementMinimaxBot extends MovementBot {
  private static final Logger logger = LoggerFactory.getLogger(AlphaBetaMovementMinimaxBot.class);
   ...
   */
  public AlphaBetaMovementMinimaxBot(int maxDepth) {
